...
declare global {
  ...
  const API_UPDATE_: typeof import('./src/api/config/common')['API_UPDATE_']
  ...
  const GENDER: typeof import('./src/enums/settle')['GENDER']
  const PAI: typeof import('./src/api/config/common')['PAI']
  const WEEK: typeof import('./src/enums/settle')['WEEK']
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { GENDER } from './src/enums/settle'
