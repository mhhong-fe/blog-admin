    ...
    <div class="h-100vh w-100vw flex justify-center items-center bg-#eef2f4">
        <div class="card flex w-925px h-660px border-rd-5 overflow-hidden">
            ...
            <div class="w-50% bg-#fff pt-45">
                ...
                <div class="flex justify-center">
                    ...
                    >
                        <el-form-item label="username" prop="username">
                            <el-input v-model="formData.username" style="width: 260px" maxlength="10" />
                        </el-form-item>
                ...
                <div class="flex items-center w-100% scale-70 ml-10 mt-6 justify-end">
...
import CodeSrc from '@/assets/imgs/code.svg';
import ExploreSrc from '@/assets/imgs/explore.svg';
import { API_USER_LOGIN, API_USER_REGISTER } from '~/api/config/common';
